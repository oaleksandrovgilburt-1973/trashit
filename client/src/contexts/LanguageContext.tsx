...
const bg: Translations = {
  ...
  noData: "Няма данни",
  or: "или",
  heroTitle: "Боклукът излиза. Ти си оставаш вкъщи.",
  heroLine1: "TRASHit е твоята модерна услуга за лесно и удобно изхвърляне на отпадъци от дома. Спести време и усилия – ние се грижим за всичко.",
...
const en: Translations = {
  ...
  noData: "No data",
  or: "or",
  heroTitle: "The trash leaves. You stay home.",
  heroLine1: "TRASHit is your modern service for easy and convenient waste disposal from home. Save time and effort – we take care of everything.",
